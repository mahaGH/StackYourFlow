	...
	<body>
		...
		<div id="show-answer" class="content scaffold-show" role="main">
			...
			<ol class="property-list answer">
				...
				<g:if test="${answerInstance?._score}">
				<li class="fieldcontain">
					<span id="_score-label" class="property-label"><g:message code="answer._score.label" default="Score" /></span>
					
						<span class="property-value" aria-labelledby="_score-label"><g:fieldValue bean="${answerInstance}" field="_score"/></span>
				...
				<g:if test="${answerInstance?._text}">
				<li class="fieldcontain">
					<span id="_text-label" class="property-label"><g:message code="answer._text.label" default="Text" /></span>
					
						<span class="property-value" aria-labelledby="_text-label"><g:fieldValue bean="${answerInstance}" field="_text"/></span>
